    ...
    <table cellspacing="0" cellpadding="0" border="0">
        <form name="myedit" id="myedit" method="post" action="[{$oViewConf->getSelfLink()}]" enctype="multipart/form-data">
            ...
            <tr>
                <td class="edittext" height="40"></td>
                <td class="edittext">
                    <input type="checkbox" class="edittext" name="blAutoFillCSV" value="1" [{$readonly}]>[{oxmultilang ident="GENIMPORT_AUTOFILL"}]
                </td>
            </tr>
            <tr>
                <td class="edittext" height="40"></td>
            ...
            <tr>
                ...
                <td class="edittext">
                    <select name="aCsvFields[[{$sCsvField}]]" style="width: 210px;">
                        ...
                        <option value="[{$sDbField}]" [{if $sDbField == $sCsvField && $blAutoFillCSV}]selected[{/if}]>[{$sDbField}]</option>
                        [{/foreach}]
                    </select>
